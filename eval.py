...
flags.DEFINE_string('outdir', 'output/test_out', 'Output directory')
flags.DEFINE_string('resdir', 'results', 'Directory to visualize prediction')

# Dataset arguments
flags.DEFINE_string('dataset', 'camvid', 'Dataset name')
flags.DEFINE_string('checkpoint_dir', 'output/train_out/segnet/trained_model',
    'Directory where to read model checkpoint.')
flags.DEFINE_string('indir', '../Dataset/IronData_Camvid/', 'Dataset directory')
...
flags.DEFINE_integer('num_sample', 400, 'Number of test samples')
