...
def encoder(inputs, phase_train, name='encoder'):
    with tf.variable_scope(name):
        ...
        h, mask_6 = n_enc_block(h, phase_train, n=3, k=512, name='block_6')
    return h, [mask_6, mask_5, mask_4, mask_3, mask_2, mask_1]
...
def decoder(inputs, mask, phase_train, name='decoder'):
    with tf.variable_scope(name):
        h = n_dec_block(inputs, mask[0], False, phase_train, n=3, k=512, name='block_6')
        h = n_dec_block(h, mask[1], False, phase_train, n=3, k=512, name='block_5')
        h = n_dec_block(h, mask[2], True, phase_train, n=3, k=512, name='block_4')
        h = n_dec_block(h, mask[3], True, phase_train, n=3, k=256, name='block_3')
        h = n_dec_block(h, mask[4], True, phase_train, n=2, k=128, name='block_2')
        h = n_dec_block(h, mask[5], True, phase_train, n=2, k=64, name='block_1')
